                    ...
                    if ($ota_date != $last_ota_date) {
                        echo json_encode( array(
                 	        ...
                 	        "message" => array(
                 	            ...
                 	            "ota_host_url" => "technolab4iot.us-east-1.elasticbeanstalk.com",
                 	            "ota_bin_uri" => "/smart_tank/OTAs/".$last_ota_date."/".$last_ota_name,
             	                "ota_full_url" => "technolab4iot.us-east-1.elasticbeanstalk.com/smart_tank/OTAs/".$last_ota_date."/".$last_ota_name,
             	            ) 
         	            ));    
                    } else {
                        echo json_encode( array(
